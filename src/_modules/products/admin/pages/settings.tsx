...
export default function ProductsSettings({ adminPath: propAdminPath }: { adminPath?: string }) {
  ...
  return (
    <div className="space-y-6">
      <ModuleLayout
        ...
        description="Configure default listing parameters, inventory alert thresholds, and pricing tax rates."
        moduleKey="products"
