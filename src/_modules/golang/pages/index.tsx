...
export default function GolangPage() {
  ...
  return (
    <main className="min-h-screen bg-neutral-955 text-neutral-100 flex flex-col items-center justify-center p-6">
      <div className="max-w-xl w-full border border-neutral-800 bg-neutral-900/50 p-6 space-y-6">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-sky-400">System Compiler</span>
          <h1 className="text-3xl font-extrabold tracking-tight mt-1 text-white">Go compiler</h1>
          <p className="text-xs text-neutral-400 mt-2">
            Status check for local Golang SDK and compiler active executable.
          </p>
        </div>
