...
export default function BlogPage({ adminPath: propAdminPath }: { adminPath?: string }) {
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      <section className="mx-auto w-full max-w-5xl px-6 py-14 md:py-20">
        <ModuleLayout
          title="Blog"
          description="Editorial content, taxonomy, and admin settings for the blog module."
          moduleKey="blog"
