...
export default function BlogSettings({ adminPath: propAdminPath }: { adminPath?: string }) {
  ...
  return (
    <div className="space-y-6">
      <ModuleLayout
        title="Blog Settings"
        description="Configure editorial defaults, publishing state, and post listing behavior."
        moduleKey="blog"
        settingsHref={`/${adminPath}/modules/blog`}
      >
        <div className="border border-slate-800 bg-slate-900/40 p-6 shadow-xl backdrop-blur-md">
          <div className="mt-0 grid grid-cols-1 gap-6 md:grid-cols-2">
