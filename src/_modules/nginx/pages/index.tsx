  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col items-center justify-center p-6">
      <div className="max-w-xl w-full border border-neutral-800 bg-neutral-900/50 p-6 space-y-6">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-sky-400">System Web Server</span>
          <h1 className="text-3xl font-extrabold tracking-tight mt-1 text-white">Nginx Web Server</h1>
          <p className="text-xs text-neutral-400 mt-2">
            Status check for local Nginx installation and configuration service.
          </p>
        </div>
