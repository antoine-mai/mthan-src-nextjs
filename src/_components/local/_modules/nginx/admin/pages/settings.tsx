...
export default function NginxSettings() {
  ...
  return (
    <div className="space-y-6">
      <ModuleLayout
        ...
        description="Diagnostic logs and status verification for local Nginx service."
      >
        <div className="border border-slate-800 bg-slate-900/40 p-6 shadow-xl backdrop-blur-md">
          <div className="flex justify-between items-start border-b border-slate-800/80 pb-4">
            <div>
              <h4 className="text-lg font-bold text-slate-100 font-mono">Nginx Config</h4>
              <p className="mt-1 text-xs text-slate-500">
                Diagnostic logs and status verification for local Nginx service.
              </p>
            </div>
            <div>
              {loading ? (
          ...
          <div className="mt-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <span className="block text-xs font-semibold text-slate-400">Config Path Target</span>
                <input
                  type="text"
                  readOnly
            ...
            <div className="space-y-2">
              <span className="block text-xs font-semibold text-slate-400">Nginx Version Diagnostics Output</span>
